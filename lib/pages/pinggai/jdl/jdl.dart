...
class JDL extends StatefulWidget {
  const JDL({super.key});

  @override
  JDLState createState() => JDLState();
}

class JDLState extends State<JDL> with SingleTickerProviderStateMixin {
  // 状态栏
  int userTotal = 0;
  int keyTotal = 0;
  int allTaskTotal = 0;
  ...
  // 请求实例
  final axios = Axios(
    baseUrl: 'https://gatorade.cn',
    defaultHeaders: {
      'Origin': 'https://gatorade.cn',
      'Referer': 'https://gatorade.cn/dist/index.html',
    },
  );
